...
-- Started on 2014-01-02 18:52:44
...
--
-- TOC entry 206 (class 1255 OID 18511)
...
--
-- TOC entry 184 (class 1259 OID 18741)
...
--
-- TOC entry 185 (class 1259 OID 18745)
-- Name: v_kompositionen; Type: VIEW; Schema: clique; Owner: postgres
--

CREATE VIEW v_kompositionen AS
 SELECT kompositionen.id,
    kompositionen.titel,
    kompositionen.datum,
    kompositionen.schrift_cd,
    kompositionen.verlag_id,
    kompositionen.werk_id,
    kompositionen.autor_id,
    kompositionen.rec_created,
    kompositionen.rec_last_updated
   FROM kompositionen;


ALTER TABLE clique.v_kompositionen OWNER TO postgres;
...
--
-- TOC entry 190 (class 1259 OID 18776)
-- Name: v_r_kompositionen; Type: VIEW; Schema: clique; Owner: postgres
--

CREATE VIEW v_r_kompositionen AS
 SELECT kompositionen.id AS k_id,
   ...
   FROM ((((kompositionen
   LEFT JOIN verlage ON ((kompositionen.verlag_id = verlage.id)))
   LEFT JOIN werke ON ((kompositionen.werk_id = werke.id)))
   LEFT JOIN autoren ON ((kompositionen.autor_id = autoren.id)))
   LEFT JOIN lt_schrift ON ((kompositionen.schrift_cd = lt_schrift.cd)));


ALTER TABLE clique.v_r_kompositionen OWNER TO postgres;

--
-- TOC entry 189 (class 1259 OID 18761)
-- Name: v_r_skizzen; Type: VIEW; Schema: clique; Owner: postgres
--

CREATE VIEW v_r_skizzen AS
 SELECT skizzen.id,
    skizzen.url,
    skizzen.werk_id,
    skizzen.vers_nr,
    ...
    verlage.ort
   FROM ((skizzen
   LEFT JOIN werke ON ((skizzen.werk_id = werke.id)))
   LEFT JOIN verlage ON ((werke.verlag_id = verlage.id)));


ALTER TABLE clique.v_r_skizzen OWNER TO postgres;

--
-- TOC entry 191 (class 1259 OID 18781)
...
--
-- TOC entry 186 (class 1259 OID 18749)
-- Name: v_skizzen; Type: VIEW; Schema: clique; Owner: postgres
--

CREATE VIEW v_skizzen AS
 SELECT skizzen.id,
    skizzen.url,
    skizzen.autor_id,
    skizzen.werk_id,
...
ALTER TABLE clique.v_skizzen OWNER TO postgres;

--
-- TOC entry 187 (class 1259 OID 18753)
...
--
-- TOC entry 188 (class 1259 OID 18757)
...
--
-- TOC entry 1894 (class 2604 OID 18581)
...
--
-- TOC entry 1900 (class 2604 OID 18678)
-- Name: id; Type: DEFAULT; Schema: clique; Owner: postgres
--
...
--
-- TOC entry 1903 (class 2604 OID 18738)
-- Name: id; Type: DEFAULT; Schema: clique; Owner: postgres
--
...
--
-- TOC entry 1892 (class 2604 OID 18524)
-- Name: id; Type: DEFAULT; Schema: clique; Owner: postgres
--
...
--
-- TOC entry 1896 (class 2604 OID 18615)
-- Name: id; Type: DEFAULT; Schema: clique; Owner: postgres
--
...
--
-- TOC entry 1898 (class 2604 OID 18628)
-- Name: id; Type: DEFAULT; Schema: clique; Owner: postgres
--
...
--
-- TOC entry 2053 (class 0 OID 18578)
-- Dependencies: 175
...
--
-- TOC entry 2059 (class 0 OID 18675)
-- Dependencies: 181
...
--
-- TOC entry 2061 (class 0 OID 18735)
-- Dependencies: 183
...
--
-- TOC entry 2051 (class 0 OID 18521)
-- Dependencies: 173
...
--
-- TOC entry 2055 (class 0 OID 18612)
-- Dependencies: 177
...
--
-- TOC entry 2057 (class 0 OID 18625)
-- Dependencies: 179
...
--
-- TOC entry 1910 (class 2606 OID 18584)
...
--
-- TOC entry 1920 (class 2606 OID 18682)
...
--
-- TOC entry 1922 (class 2606 OID 18740)
...
--
-- TOC entry 1907 (class 2606 OID 18530)
...
--
-- TOC entry 1912 (class 2606 OID 18621)
...
--
-- TOC entry 1915 (class 2606 OID 18631)
...
--
-- TOC entry 1916 (class 1259 OID 18698)
...
--
-- TOC entry 1917 (class 1259 OID 18699)
...
--
-- TOC entry 1918 (class 1259 OID 18700)
...
--
-- TOC entry 1904 (class 1259 OID 18541)
...
--
-- TOC entry 1905 (class 1259 OID 18542)
...
--
-- TOC entry 1913 (class 1259 OID 18637)
...
--
-- TOC entry 1908 (class 1259 OID 18585)
...
--
-- TOC entry 1930 (class 2620 OID 18586)
...
--
-- TOC entry 1933 (class 2620 OID 18701)
...
--
-- TOC entry 1929 (class 2620 OID 18543)
...
--
-- TOC entry 1931 (class 2620 OID 18622)
...
--
-- TOC entry 1932 (class 2620 OID 18638)
...
--
-- TOC entry 1926 (class 2606 OID 18683)
...
--
-- TOC entry 1927 (class 2606 OID 18688)
...
--
-- TOC entry 1928 (class 2606 OID 18693)
...
--
-- TOC entry 1923 (class 2606 OID 18655)
...
--
-- TOC entry 1925 (class 2606 OID 18632)
...
--
-- TOC entry 1924 (class 2606 OID 18660)
...
-- Dependencies: 183
-- Name: lt_schrift; Type: ACL; Schema: clique; Owner: postgres
--

REVOKE ALL ON TABLE lt_schrift FROM PUBLIC;
REVOKE ALL ON TABLE lt_schrift FROM postgres;
GRANT ALL ON TABLE lt_schrift TO postgres;
GRANT ALL ON TABLE lt_schrift TO clique_admins;
...
-- Dependencies: 185
-- Name: v_kompositionen; Type: ACL; Schema: clique; Owner: postgres
--

REVOKE ALL ON TABLE v_kompositionen FROM PUBLIC;
REVOKE ALL ON TABLE v_kompositionen FROM postgres;
GRANT ALL ON TABLE v_kompositionen TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE v_kompositionen TO clique_admins;
GRANT SELECT ON TABLE v_kompositionen TO PUBLIC;
...
-- Dependencies: 190
-- Name: v_r_kompositionen; Type: ACL; Schema: clique; Owner: postgres
--

REVOKE ALL ON TABLE v_r_kompositionen FROM PUBLIC;
REVOKE ALL ON TABLE v_r_kompositionen FROM postgres;
GRANT ALL ON TABLE v_r_kompositionen TO postgres;
GRANT SELECT ON TABLE v_r_kompositionen TO PUBLIC;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE v_r_kompositionen TO clique_admins;


--
-- TOC entry 2081 (class 0 OID 0)
-- Dependencies: 189
-- Name: v_r_skizzen; Type: ACL; Schema: clique; Owner: postgres
--

REVOKE ALL ON TABLE v_r_skizzen FROM PUBLIC;
REVOKE ALL ON TABLE v_r_skizzen FROM postgres;
GRANT ALL ON TABLE v_r_skizzen TO postgres;
GRANT SELECT ON TABLE v_r_skizzen TO PUBLIC;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE v_r_skizzen TO clique_admins;
...
-- Dependencies: 186
-- Name: v_skizzen; Type: ACL; Schema: clique; Owner: postgres
--

REVOKE ALL ON TABLE v_skizzen FROM PUBLIC;
REVOKE ALL ON TABLE v_skizzen FROM postgres;
GRANT ALL ON TABLE v_skizzen TO postgres;
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,UPDATE ON TABLE v_skizzen TO clique_admins;
GRANT SELECT ON TABLE v_skizzen TO PUBLIC;
...
-- Completed on 2014-01-02 18:52:45
