...
-- Started on 2014-01-05 18:11:55
...
CREATE VIEW v_r_dokumente AS
 SELECT dokumente.id AS d_id,
   ...
   LEFT JOIN lt_schrift ON ((dokumente.schrift_cd = lt_schrift.cd)))
  ORDER BY dokumente.id;
...
--
-- TOC entry 1902 (class 1259 OID 18855)
...
--
-- TOC entry 1903 (class 1259 OID 18856)
-- Name: idx_rhythmus_gerade; Type: INDEX; Schema: clique; Owner: postgres; Tablespace: 
--

CREATE INDEX idx_rhythmus_gerade ON dokumente USING btree (rhytmus_gerade);


--
-- TOC entry 1904 (class 1259 OID 18857)
...
--
-- TOC entry 1905 (class 1259 OID 18858)
-- Name: idx_schrift_cd; Type: INDEX; Schema: clique; Owner: postgres; Tablespace: 
--

CREATE INDEX idx_schrift_cd ON dokumente USING btree (schrift_cd);
...
-- Completed on 2014-01-05 18:11:55
